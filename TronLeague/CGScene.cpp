...
CGScene::CGScene(CGObject* moto, CGFigure* pelota)
{
    ...
    matMuros->InitTexture("textures/Tiles_048_basecolor.jpg"); // Textura de los muros
    ...
    float gateWidth = 30.0f; // Ancho del hueco para la portería


    //new CGCube(ancho, alto, profundidad);
   // Muro trasero
...
void CGScene::Draw(CGShaderProgram* program, glm::mat4 proj, glm::mat4 view, glm::mat4 shadowViewMatrix)
{
    ...
    //
    motoTron->Draw(program, proj, view);
